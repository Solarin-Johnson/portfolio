    ...
    return(
        <div className="projects">
            ...
            <div className="previews">
                ...
                <Preview name='Search Image' description='A Simple Image Search App that gives images based on your search keyword, with a feature to filter the searched images results' languages='HTML, CSS and Javascript' screenshot={'https://solarin-johnson.github.io/screenshots/search_images.png'} link='https://solarin-johnson.github.io/image/image.html' git_repo='https://github.com/Solarin-Johnson/Solarin-Johnson.github.io/tree/14acaf4dfaa6442dc051cc4efdb23db19691e895/image' />
